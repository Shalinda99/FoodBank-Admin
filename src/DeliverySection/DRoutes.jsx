...
const DRoutes = () => {
    ...
    '/PackageRequsition1' ,'/PackageRequsition2','/DeliveryStatus1' ,'/DeliveryStatus2','/foodDonations','/collectionSummary','/collectDonations']; // include only these paths to render navbar
    return ( 
        <React.Fragment>
